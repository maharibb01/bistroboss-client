                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex gap-6">
                        ...
                        <label className="form-control w-full mb-2">
                            ...
                            <input {...register("price", { required: true })} type="text" placeholder="recipe price" className="input input-bordered w-full" />
                        </label>
                    </div>
                    {/* details */}
                    ...
                    <button className="btn bg-orange-600 text-white mt-6">Add Items <FaUtensils></FaUtensils></button>
                </form>
            </div>
        </div>
    );
